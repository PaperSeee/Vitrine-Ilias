...
const mainServices = [
  {
    ...
    description: "Sites web élégants et responsives pour présenter votre activité avec style et professionnalisme.",
    price: 300,
    priceDisplay: "300€",
  ...
  },
  {
    icon: ShoppingCart,
    title: "Site complet",
    description: "Boutiques en ligne complètes avec gestion des produits, paiements sécurisés et tableau de bord.",
    price: 650,
    priceDisplay: "500-800€",
    features: ["Catalogue produits", "Paiement sécurisé", "Gestion commandes", "Analytics"],
    color: "accent",
  },
  {
    icon: FileText,
    title: "Landing Pages",
    description: "Pages de conversion optimisées pour maximiser vos taux de transformation et générer des leads.",
    price: 300,
    priceDisplay: "300€",
...
const upsells = [
  {
    icon: PenTool,
    title: "Web Writing",
    description: "Rédaction de contenu web optimisé SEO pour améliorer votre visibilité et engagement.",
    price: 100,
    priceDisplay: "+100€",
  ...
  },
  {
    ...
    description: "Hébergement professionnel, maintenance, mises à jour et support technique continu.",
    price: 25,
...
export function ServicesSection() {
  ...
  const handleUpsellToggle = (index: number) => {
    setSelectedUpsells((prev) => (prev.includes(index) ? prev.filter((i) => i !== index) : [...prev, index]))
  }
  ...
  const handleShowSummary = () => {
    ...
    const oneTimeTotal =
      service.price + selectedUpsellItems.filter((u) => !u.monthly).reduce((sum, u) => sum + u.price, 0)
